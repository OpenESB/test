...
/**
 * This plugin is used to generate the Service Unit archive
 * 
 ...
 * @phase package
 */
public class ServiceUnitMojo extends AbstractServiceUnitMojo {
	 ...
	 * @parameter default-value="SEDeployment.jar"
	 * 
	 */
